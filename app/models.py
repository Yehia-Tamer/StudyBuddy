...
class User(Base):
    ...
    flashcards = relationship(
        "FlashCard", back_populates="owner", cascade="all, delete-orphan"
    )
    study_plans = relationship(
        "StudyPlan", back_populates="owner", cascade="all, delete-orphan"
    )
...
class Document(Base):
    ...
    flashcards_used_in = relationship(
        "FlashCard", secondary=flashcard_documents, back_populates="documents"
    )
    quizzes_used_in = relationship(
        "Quiz", secondary=quiz_documents, back_populates="documents"
    )
    study_plans_used_in = relationship(
        "StudyPlan", secondary=study_plan_documents, back_populates="documents"
    )
    cheat_sheets_used_in = relationship(
        "CheatSheet", secondary=cheat_sheet_documents, back_populates="documents"
    )
...
class FlashCard(Base):
    ...
    documents = relationship(
        "Document", secondary=flashcard_documents, back_populates="flashcards_used_in"
    )
...
class StudyPlan(Base):
    ...
    items = relationship(
        "StudyPlanItem", back_populates="study_plan", cascade="all, delete-orphan"
    )
    documents = relationship(
        "Document", secondary=study_plan_documents, back_populates="study_plans_used_in"
    )
...
class Quiz(Base):
    ...
    documents = relationship(
        "Document", secondary=quiz_documents, back_populates="quizzes_used_in"
    )
...
class CheatSheet(Base):
    ...
    documents = relationship(
        "Document",
        secondary=cheat_sheet_documents,
        back_populates="cheat_sheets_used_in",
    )
