...
def generate_and_save_quiz(
    user_id: int, document_ids: list[int], difficulty: str, count: int, db: Session
):
    documents = (
    ...
    questions, topic, time_estimate_minutes = quiz_chain.generate_quiz(
        user_id, document_ids, difficulty, count
    )
